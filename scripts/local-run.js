 ...
 *     node scripts/local-run.js --dry [--date 2026-07-30] [--lookback 20]
 *
...
const lookbackMinutes = lookbackIdx >= 0 ? Number(args[lookbackIdx + 1]) : null;
...
const stats = await runFollowUp({ dryRun, date, lookbackMinutes });
